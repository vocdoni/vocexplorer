...
// Contents of this file from https://github.com/tendermint/tendermint/blob/release/v0.33.7/rpc/jsonrpc/client/decode.go
// non-exported custom json unmarshal functions for custom jsonrpc layer

// UnmarshalResponseBytes unmarshalls a jsonrpc response into a response object
...
// UnmarshalResponseBytesArray unmarshalls a jsonrpc response array into an array of response objects
