...
var file_db_proto_goTypes = []interface{}{
	...
	(*Envelope)(nil),            // 2: dbtypes.Envelope
...
var file_db_proto_depIdxs = []int32{
	10, // 0: proto.BlockchainInfo.GenesisTimeStamp:type_name -> google.protobuf.Timestamp
	10, // 1: proto.StoreBlock.Time:type_name -> google.protobuf.Timestamp
